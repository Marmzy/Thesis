...
countData <- as.matrix(read.csv("transcript_count_matrix_GSE49911_Plant_Welch.csv",
                                sep=",",
                                row.names="transcript_id"))

#Chaning the "transfect" names, so it doesn't contain any special characters
...
write.csv(resData[pseudogenes,],
          file="GSE49911_Plant_Welch(time_25h_vs_7h).csv")
```
