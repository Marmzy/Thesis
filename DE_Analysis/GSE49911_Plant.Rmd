...
countData <- as.matrix(read.csv("transcript_count_matrix_GSE49911_Plant.csv",
                                sep=",",
...
#Getting the results and shrinking the Log-fold change (LFC) estimates, for visualization and ranking of (pseudo)genes
...
#Write DE pseudogenes to a new csv file
write.csv(resData[pseudogenes,],
          file="GSE49911_Plant(time_25h_vs_7h).csv")
```
...
#Write DE pseudogenes to a new csv file
write.csv(resData[pseudogenes,],
          file="GSE49911_Plant(time_12h_vs_7h)(time_25h_vs_7h).csv")
```
...
#Write DE pseudogenes to a new csv file
write.csv(resData[pseudogenes,],
          file="GSE49911_Plant(time_25h_vs_7h)(transfectPtrSND1B1.time25h).csv")
```
...
res <- results(object=dds,
               ...
               pAdjustMethod="BH",
               lfcThreshold=0,
               contrast=list(c("transfectPtrSND1B1.time25h", "transfectPtrSND1B1.time12h")),
               test="Wald")
summary(res)
